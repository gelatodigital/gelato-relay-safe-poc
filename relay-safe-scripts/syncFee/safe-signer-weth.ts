...
const WETH_ADDRESS = "0x4200000000000000000000000000000000000006"; // WETH address on Base Sepolia
...
async function relayTransaction() {
  ...
  try {
    const response = await relayKit.executeTransaction({
      ...
      options: { gasLimit, isSponsored: false, gasToken: WETH_ADDRESS }, // Use WETH as gasToken
    });
